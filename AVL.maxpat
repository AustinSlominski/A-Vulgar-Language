...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "" ],
									"patching_rect" : [ 84.0, 60.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "t 1 l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 16.0, 129.0, 98.0, 22.0 ],
									"style" : "",
									"text" : "zl.queue"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 16.0, 57.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 16.0, 90.5, 71.0, 22.0 ],
									"style" : "",
									"text" : "metro 1000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 162.5, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 274.0, 162.5, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "" ],
									"patching_rect" : [ 342.0, 60.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "t 1 l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 274.0, 129.0, 98.0, 22.0 ],
									"style" : "",
									"text" : "zl.queue"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 274.0, 57.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 274.0, 90.5, 71.0, 22.0 ],
									"style" : "",
									"text" : "metro 1000"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 362.5, 121.0, 283.5, 121.0 ],
									"source" : [ "obj-35", 1 ],
									"watchpoint_flags" : 1,
									"watchpoint_id" : 1
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 104.5, 121.0, 25.5, 121.0 ],
									"source" : [ "obj-7", 1 ],
									"watchpoint_flags" : 1,
									"watchpoint_id" : 4
								}
...
,
					"patching_rect" : [ 20.666677, 400.0, 179.333328, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.666672, 61.0, 261.0, 28.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 16.0,
					"id" : "obj-3",
					"items" : "formatted_english_graphemes.json",
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 20.666672, 156.0, 86.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.666672, 125.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "import $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.666672, 91.0, 261.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.666672, 6.0, 214.0, 35.0 ],
					"style" : "",
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 151.166672, 119.25, 82.0, 119.25, 82.0, 119.5, 30.166672, 119.5 ],
					"source" : [ "obj-1", 1 ]
				}
